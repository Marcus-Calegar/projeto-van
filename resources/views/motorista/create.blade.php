<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('register.motorista') }}">
                @csrf
                ...
                <!-- Mensalidade -->
                <div class="mt-4">
                    <x-input-label for="mensalidade" :value="__('Mensalidade')" />
                    <x-text-input id="mensalidade" class="block mt-1 w-full" type="number" min="0" step=".01" name="mensalidade" required />
                </div>
